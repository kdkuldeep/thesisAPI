...
{
  exports.Set(Napi::String::New(env, "solveAsyncWithCapacityConstraints"), Napi::Function::New(env, solveAsyncWithCapacityConstraints));
  exports.Set(Napi::String::New(env, "solveAsyncWithReserveConstraints"), Napi::Function::New(env, solveAsyncWithReserveConstraints));
  return exports;
}
